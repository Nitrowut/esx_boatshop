...
--			GaragePos  = vector3(-772.4, -1430.9, 0.7),
--			SpawnPoint = vector4(-785.39, -1426.3, 0.0, 146.0),
--			StorePos   = vector3(-798.4, -1456.0, 1.2),
--			StoreTP    = vector4(-791.4, -1452.5, 1.5, 318.9)
--		},
--
--		{ -- Catfish View
--			GaragePos  = vector3(3864.9, 4463.9, 1.8),
--			SpawnPoint = vector4(3854.4, 4477.2, 0.0, 273.0),
--			StorePos   = vector3(3857.0, 4446.9, 0.3),
--			StoreTP    = vector4(3854.7, 4458.6, 1.9, 355.3)
--		},
--
--		{ -- Great Ocean Highway
--			GaragePos  = vector3(-1614.0, 5260.1, 3.1),
--			SpawnPoint = vector4(-1622.5, 5247.1, 0.0, 21.0),
--			StorePos   = vector3(-1600.3, 5261.9, 0.4),
--			StoreTP    = vector4(-1605.7, 5259.0, 2.0, 25.0)
--		},
--
--		{ -- North Calafia Way
--			GaragePos  = vector3(712.6, 4093.3, 33.9),
--			SpawnPoint = vector4(712.8, 4080.2, 29.3, 181.0),
--			StorePos   = vector3(705.1, 4110.1, 30.5),
--			StoreTP    = vector4(711.9, 4110.5, 31.3, 180.0)
--		},
--
--		{ -- Elysian Fields, nearby the airport
--			GaragePos  = vector3(23.8, -2806.8, 4.85),
--			SpawnPoint = vector4(23.3, -2828.6, 0.8, 181.0),
--			StorePos   = vector3(-1.0, -2799.2, 0.9),
--			StoreTP    = vector4(12.6, -2793.8, 2.5, 355.2)
--		},
--
--		{ -- Barbareno Rd
--			GaragePos  = vector3(-3427.3, 956.9, 7.45),
--			SpawnPoint = vector4(-3448.9, 953.8, 0.0, 75.0),
--			StorePos   = vector3(-3436.5, 946.6, 1.2),
...
--
	...
	BoatShops = {
		...
		{ -- Shank St, nearby campaign boat garage
			Outside = vector3(-773.7, -1495.2, 1.9),
...
Config.Vehicles = {
	...
	{model = 'marquis', label = 'Marquis', price = 12000},
